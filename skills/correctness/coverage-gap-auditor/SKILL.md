...
description: Audits which code paths in a change lack test coverage, maps the diff to existing tests and reports prioritized untested gaps with fix suggestions. Use for coverage reviews or risky-diff pre-ship checks.
---
...
- Original path: plugins/testing/test-coverage-analyzer/skills/analyzing-test-coverage/SKILL.md
- License: MIT
