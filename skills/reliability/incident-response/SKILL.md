...
description: Runs incident response end to end - SEV classification, triage, escalation paths and evidence handling for declared incidents, following a NIST SP 800-61 style lifecycle.
---
...
- Original path: engineering-team/skills/incident-response/SKILL.md
- License: MIT
