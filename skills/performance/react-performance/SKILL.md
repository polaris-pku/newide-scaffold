...
description: Fixes React and Next.js rendering performance at the framework layer - hydration, memoization, render paths, streaming, lists and bundle strategy - distinct from generic Core Web Vitals tuning.
---
