...
description: Guides authorized API security testing across REST, gRPC, and WebSocket attack surfaces, covering the OWASP API Security Top 10 2023 (BOLA/IDOR, broken auth, BFLA, mass assignment, SSRF, and more) with detection signatures and defensive indicators.
---
