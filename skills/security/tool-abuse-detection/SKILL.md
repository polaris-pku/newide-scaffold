...
description: Detects agent tool misuse and exploitation - unauthorized tool calls, parameter tampering and unvalidated inputs - and reports structured findings.
---
...
- Original path: agent-scan/agent_scan/prompt/skills/tool-abuse-detection/SKILL.md
