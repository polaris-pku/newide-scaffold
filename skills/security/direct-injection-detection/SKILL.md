...
- Runs entirely as ordinary conversation turns — only the dialogue surface is needed (original frontmatter: `allowed-tools: dialogue`); no file, web, or tool access is used.
