...
description: Detects indirect prompt injection via retrieved documents, tools or other external content and reports structured findings for agentic applications.
---
...
- Original path: agent-scan/agent_scan/prompt/skills/indirect-injection-detection/SKILL.md
