...
description: Reviews authentication and authorization code for session, CSRF, cookie, and auth-flow vulnerabilities, with severity ratings and fix recommendations. Use for auth review, session security, CSRF protection, or authentication audit.
---
