...
description: Audits cryptographic usage and key lifecycle against FIPS and NIST guidance - algorithms, modes, TLS, certificates, KMS and key rotation or storage. Use for crypto reviews or compliance checks.
---
...
- Source repo: https://github.com/Cosmian/kms
- Original path: .github/skills/cryptography-review/SKILL.md
