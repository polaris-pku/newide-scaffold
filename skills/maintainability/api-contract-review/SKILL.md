...
description: Audits REST API contracts for HTTP verb semantics, versioning, backward compatibility and response consistency before release or on PRs touching endpoints. Use for review API, check endpoints, REST review or pre-release contract checks.
---
...
- Original path: skills/api-contract-review/SKILL.md
- License: MIT
